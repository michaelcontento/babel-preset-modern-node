...
// ---- v0.12
            ...
            enableFor('0.12') && [require("babel-plugin-transform-es2015-classes"), { loose }],
            enableFor('0.12') && [require("babel-plugin-transform-es2015-computed-properties"), { loose }],
            enableFor('0.12') && [require("babel-plugin-transform-es2015-for-of"), { loose }],
            ...
            enableFor('0.12') && [require("babel-plugin-transform-es2015-template-literals"), { loose }],
...
// ---- v5.12
            ...
            enableFor('5.12') && [require("babel-plugin-transform-es2015-spread"), { loose }],
...
// ---- v6.3
            enableFor('6.3') && [require("babel-plugin-transform-es2015-destructuring"), { loose }],
            enableFor('6.3') && require('babel-plugin-transform-es2015-function-name'),
            enableFor('6.3') && modules === "commonjs" && [require("babel-plugin-transform-es2015-modules-commonjs"), { loose }],
            enableFor('6.3') && modules === "systemjs" && [require("babel-plugin-transform-es2015-modules-systemjs"), { loose }],
            enableFor('6.3') && modules === "amd" && [require("babel-plugin-transform-es2015-modules-amd"), { loose }],
            enableFor('6.3') && modules === "umd" && [require("babel-plugin-transform-es2015-modules-umd"), { loose }],
